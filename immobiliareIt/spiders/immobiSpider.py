...
BASEQUERYPATH = "http://www.immobiliare.it/Milano/vendita_case-Milano.html?criterio=rilevanza&pag="
startUrls = [BASEQUERYPATH+str(pageNumber) for pageNumber in range(3, 200)]
